...
//            }
            ...
            LOG.info("Captured input value from field - {}", externalTask.getVariableTyped("inut1").toString());
    ...
    public ExternalTaskHandler invoiceArchiverHandler() {
        return (externalTask, externalTaskService) -> {
            ...
            //LOG.info("Captured input value from field not passed through - {}", externalTask.getVariableTyped("inut1").toString());
